        ...
        <div className="w-full max-w-md mx-auto">
          <div className="glass-panel rounded-t-2xl flex flex-col items-center pt-8 px-8 pb-4 border-b-0">
            <img 
              ...
              className="w-28 h-28 mx-auto animate-scale-in"
            />
            <h1 className="text-2xl font-bold mt-3 mb-1 text-center bg-gradient-to-r from-blue-600 to-red-600 bg-clip-text text-transparent">
              Encuestas VA
            </h1>
